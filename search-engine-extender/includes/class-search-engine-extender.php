...
class Search_Engine_Extender
{
   ...
   *
   * - Search_Engine_Extender_Loader. Orchestrates the hooks of the plugin.
   * - Search_Engine_Extender_i18n. Defines internationalization functionality.
   * - Search_Engine_Extender_Admin. Defines all hooks for the admin area.
   * - Search_Engine_Extender_Public. Defines all hooks for the public side of the site.
   *
